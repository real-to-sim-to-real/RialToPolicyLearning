...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs, observation_space, action_space, goal_space=None, state_space=None):
        self.num_envs = num_envs
        self.observation_space = observation_space
        self.action_space = action_space
        self.goal_space = goal_space or observation_space
        self.state_space = state_space or observation_space
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(self, venv, observation_space=None, action_space=None, state_space=None, goal_space=None):
        self.venv = venv
        VecEnv.__init__(self, num_envs=venv.num_envs, 
                        observation_space=observation_space or venv.observation_space,
                        action_space=action_space or venv.action_space,
                        goal_space=goal_space or venv.goal_space,
                        state_space=state_space or venv.state_space)
