...
from goalsrl.envs.vec_env import VecEnv, CloudpickleWrapper
    ...
    while True:
        try:
            ...
            if cmd == 'step':
                ...
                remote.send((env.observation_space, env.action_space, env.state_space, env.goal_space))
            elif cmd == 'env_method':
...
class SubprocVecEnv(VecEnv):
    ...
    def __init__(self, env_fns, start_method=None):
        ...
        for i, remote in enumerate(self.remotes):
            remote.send(('set_seed', seed+i))

        self.remotes[0].send(('get_spaces', None))
        observation_space, action_space, state_space, goal_space = self.remotes[0].recv()
