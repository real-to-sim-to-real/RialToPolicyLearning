...
from rialto.algo.dense_cnn_model import DenseFeatureExtractor, SparseFeatureExtractor
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        # nn.Sequential(*[
        #     nn.Linear(self.mlp_extractor.shared_net[0].in_features, self.mlp_extractor.latent_dim_vf),
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        values = self.value_net(latent_vf) # TODO: before we had obs here
...
class ActorCriticSparse3DPolicy(ActorCriticPolicy):
    """
    CNN policy class for actor-critic algorithms (has both policy and value prediction).
    Used by A2C, PPO and the likes.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        squash_output: bool = False,
        features_extractor_class = SparseFeatureExtractor,
        features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        normalize_images: bool = True,
        optimizer_class: Type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: Optional[Dict[str, Any]] = None,
...
class ActorCritic3DPolicy(ActorCriticPolicy):
    """
    CNN policy class for actor-critic algorithms (has both policy and value prediction).
    Used by A2C, PPO and the likes.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        squash_output: bool = False,
        features_extractor_class = DenseFeatureExtractor,
        features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        normalize_images: bool = True,
        optimizer_class: Type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: Optional[Dict[str, Any]] = None,
