...
FRANKA_PANDA_ARM_WITH_PANDA_HAND_CFG = SingleArmManipulatorCfg(
    ...
    actuator_groups={
        "panda_shoulder": ActuatorGroupCfg(
            ...
            model_cfg=ImplicitActuatorCfg(velocity_limit=1000.0, torque_limit=1000.0), #100 100 #87
            control_cfg=ActuatorControlCfg(
                command_types=["p_abs"],
                stiffness={".*": 1000.0}, #800
                damping={".*": 60.0}, #40
                dof_pos_offset={
                    "panda_joint1": 0.0,
                    "panda_joint2": -0.569,
        ...
        "panda_forearm": ActuatorGroupCfg(
            ...
            model_cfg=ImplicitActuatorCfg(velocity_limit=1000.0, torque_limit=1000.0), #12
            control_cfg=ActuatorControlCfg(
                command_types=["p_abs"],
                stiffness={".*": 1000.0}, #800
                damping={".*": 60.0}, # 40
